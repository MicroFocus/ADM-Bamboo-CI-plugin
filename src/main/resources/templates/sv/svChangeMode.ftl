...
[@ui.bambooSection title="Change Mode of Virtual Service Task"]
    ...
    <div class="control">
        [@ww.select labelKey="sv.param.label.serviceMode" name="serviceMode" list="SVServiceModeMap" emptyOption="false"/]
    </div>
    <hr>

    <div>
        [@ww.radio labelKey='sv.param.label.dataModel' name='dataModel'
        listKey='key' listValue='value' toggle='true'
        list=SVDataModelMap ]
        [/@ww.radio]

        [@ui.bambooSection dependsOn='dataModel' showOn='BY_NAME']
            [@ww.textfield labelKey="sv.param.label.dmNameOrId" name="dmNameOrId" required='true'/]
        [/@ui.bambooSection]
    </div>
    <hr>

    <div>
        [@ww.radio labelKey='sv.param.label.performanceModel' name='performanceModel'
        listKey='key' listValue='value' toggle='true'
        list=SVPerformanceModelMap ]
        [/@ww.radio]

        [@ui.bambooSection dependsOn='performanceModel' showOn='BY_NAME']
            [@ww.textfield labelKey="sv.param.label.pmNameOrId" name="pmNameOrId" required='true'/]
        [/@ui.bambooSection]
    </div>
    <hr>

...
[@ui.bambooSection title="Undeploy Virtual Service Task"]
    ...
    <div class="control">
        [@ww.checkbox labelKey="sv.param.label.continue" name="continue" toggle="true" /]
    </div>
    <div class="helpIcon" onclick="javascript: toggle_visibility('sv.param.tooltips.continue');">?</div>
    <div id ="sv.param.tooltips.continue" class="toolTip">
        [@ww.text name="sv.param.tooltips.continue"/]
    </div>
    <hr>

[@ui.bambooSection title="LoadRunner Task"]
    ...
    [@ui.bambooSection title="LoadRunner Settings" dependsOn="lrSettings" showOn="true" ]
        [@ww.textfield labelKey="lr.param.label.pollingInterval" name="pollingInterval" required="true"/]
        [@ww.textfield labelKey="lr.param.label.execTimeout" name="execTimeout" required="true"/]
